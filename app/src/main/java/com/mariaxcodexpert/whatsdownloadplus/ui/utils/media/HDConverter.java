...
public class HDConverter {
    ...
    public static Bitmap applyAdvancedClarity(Bitmap src, int smooth, int sharp,
        ...
        if (clarity > 50) {
            ...
            clarityPaint.setAlpha((int) (130 * clarityStrength));
        ...
        if (smooth > 0 || denoise) {
            ...
            int alpha = (int) (smoothStrength * 45);

            if (denoise) alpha += 20;

            smoothPaint.setAlpha(Math.min(alpha, 70));
        ...
        if (vignette > 0) {
            ...
            vigPaint.setAlpha((int) (vignette * 2.55f));
